...
namespace COMP003A.LectureActivity7
{
    internal class Program
    {
        static void Main(string[] args)
        {
             ...
             * 
             * e.g.,
             * int[] array2 new item int[] { 1, 3, 5, 7, 9 };
             * array2[0] -> returns 1
             * array2[1] -> returns 3
             * array2[2] -> returns 5
             * array2[3] -> returns 7
             * array2[4] -> returns 9d
             * array2[5] -> RUNTIUME ERROR: Outof BoundsException
             * 
             * It is important to note that arrays cannot be dynamically resized.
             * They are stored in sequential blocks of memory, making it extremely fastto access them.
            ...
            //unlike arrays, lists are dynamic and can increase/decrrease in size.
            List<char> alphabet = new List<char>();// declarean empty integer List.
        ...
        /// Array traversal
        /// </summary>
        /// <param name="araay">String input</param>
